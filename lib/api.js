...
var APIs = {
  ...
  "anagram": function (bot, msg, apiKey, callback) {
      var url = "http://anagramgenius.com/server.php?source_text=" + encodeURIComponent(msg) + "&vulgar=1";
      var json = false;
      var options = {
          method: "GET",
          timeout: 6000
  ...
  "youtubeplaylist": function (bot, data, apiKey, callback) {
    ...
    var url = "https://www.googleapis.com:443" +
      "/youtube/v3/playlistItems?" +
      "part=contentDetails&playlistId=" + playlistId + "&key=" + apiKey + "&maxResults=" + maxResults;
    var json = true;
    var options = {
        method: "GET",
        timeout: 1500
