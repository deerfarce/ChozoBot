...
Bot.prototype.queueMedia = function(pos, src, isTemp, content, title) {
  ...
  if ((!this.CHANNEL.playlistIsLocked && !this.checkChannelPermission("oplaylistadd")) || (this.CHANNEL.playlistIsLocked && !this.checkChannelPermission("playlistadd")))
    return this.logger.error("Could not add ["+src+"]: insufficient permission to add videos.");

  if (pos == "next") {
    if ((!this.CHANNEL.playlistIsLocked && !this.checkChannelPermission("oplaylistnext")) || (this.CHANNEL.playlistIsLocked && !this.checkChannelPermission("playlistnext")))
